...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param s1 a string that will be concatenated with s2 for this Silly's instance's name
     * @param s2 a string that will be concatenated with s1 for this Silly's instance's name
     */
